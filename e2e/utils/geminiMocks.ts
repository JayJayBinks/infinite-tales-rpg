...
/**
 * Reusable helper to complete the quickstart flow.
 * Navigates to settings, saves API key, launches quickstart, and waits for game to load.
 */
export async function completeQuickstartFlow(page: Page) {
  ...
  // Verify game is ready with party
  await page.waitForSelector('h2:has-text("Story")', { timeout: 15000 });
}
