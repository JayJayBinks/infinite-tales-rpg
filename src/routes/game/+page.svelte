<script lang="ts">
    ...
    import {CharacterStatsAgent, initialCharacterStatsState, type NPCState} from "$lib/ai/agents/characterStatsAgent";
...
<div id="game-container" class="container mx-auto p-4">
    ...
    <DiceRollComponent bind:diceRollDialog={diceRollDialog} action={chosenActionState.value} resetState = {didAIProcessDiceRollActionState.value}></DiceRollComponent>
    ...
    <div id="story" class="mt-4 p-4 bg-base-100 rounded-lg shadow-md">
