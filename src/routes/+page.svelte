...
<main class="container mx-auto p-6">
    ...
    <section class="text-center my-8 bg-gray-800 p-6 rounded-lg shadow-md">
        ...
        <p class="mb-4">To begin your tale, you need a Google Gemini API Key. It's free and easy to set up! Visit <a target="_blank" href="https://aistudio.google.com/" class="text-blue-400 underline">Google AI Studio</a>, generate your API key and enter it in the settings.</p>
