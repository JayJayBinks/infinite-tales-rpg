...
export const characterStatsStateForPrompt = {
    ...
    abilities: 'Array of active abilities and spells. Do not list passive abilities. Format: [{"name": "", "effect": "", "mp_cost": integer, "difficulty", "simple|medium|difficult|very_difficult"}]',
}
