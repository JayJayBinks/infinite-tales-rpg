...
{:else}
	<dialog open class="z-100 modal" style="background: rgba(0, 0, 0, 0.3);">
		<div class="modal-box flex flex-col items-center text-center overflow-y-scroll">
			...
			<details class="collapse collapse-arrow textarea-bordered border bg-base-200 mt-4 overflow-y-scroll">
				...
				<p class="overflow-y-scroll">{gmAnswerState?.game_state_considered || 'The AI did not return a response...'}</p>
			</details>
			<details class="collapse collapse-arrow textarea-bordered border bg-base-200 mt-4 overflow-y-scroll">
				<summary class="collapse-title capitalize">
